...
<i class="fa-solid fa-house-medical fa-beat-fade" style="color: #a5c422;"></i>My Reksodiwiryo</a>
               </div>
               <!-- MENU LINKS -->
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="footer-thumb"> 
                              ...
                              <div class="contact-info">
                                   <!--<p><i class="fa-brands fa-square-whatsapp" style="color: #a5c422;"></i> <?=$_SESSION["kontak"];?></p>-->
                                   <p><i class="fa-brands fa-square-whatsapp" style="color: #a5c422;"></i> <a href="https://api.whatsapp.com/send/?phone=6281363280294&text&type=phone_number&app_absent=0">Whatsapp/081363280294</a></p>
                                   <p><i class="fa-solid fa-envelope" style="color: #a5c422;"></i> <a href="#"><?=$_SESSION["email"];?></a></p>
                                   <p><i class="fa-brands fa-square-facebook" style="color: #a5c422;"></i> <a href="https://www.facebook.com/rumkit.reksodiwiryo">RSAD dr. Reksodiwiryo</a></p>
                                   <p><i class="fa-brands fa-square-instagram" style="color: #a5c422;"></i><a href="https://www.instagram.com/rumkit.reksodiwiryo/"> @rumkit.reksodiwiryo</a></p>
                                   <p><i class="fa-brands fa-youtube" style="color: #a5c422;"></i><a href="https://www.youtube.com/@rumkit.reksodiwiryo"> RS Tk. III dr. Reksodiwiryo</a></p>
                              </div>
                         </div>
                    </div>
                    ...
                    <div class="col-md-12 col-sm-12 border-top">
                         <div class="col-md-4 col-sm-6">
                              <div class="copyright-text"> 
                                   <p>Copyright &copy; 2023 <?=$_SESSION["nama_instansi"];?> | <a href="https://rumkitreksodiwiryo.com/">ICT Reksodiwiryo</a></p>
                              </div>
                         </div>
