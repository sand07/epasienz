               ...
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.8s">
                            ...
                            Jika Bapak/ibu pasien lama atau pernah berobat sebelumnya di Rumah Sakit dr. Reksodiwiryo, Silahkan Masukkan no Rekam Medik (RM) dan Password Untuk Melakukan Pendaftaran Online.<br/><br/><br/>
                            </div>
                            <?php 
                                ...
                                if (isset($BtnLogin)) {
                                    ...
                                    echo "<form id=\"appointment-form\" role=\"form\" onsubmit=\"return validasiIsi();\" method=\"post\" action=\"\" enctype=multipart/form-data>
                                                ...
                                                <div class=\"col-md-12 col-sm-12\">
                                                    <label for=\"passworde\">Password</label>
                                                    <input type=\"text\" class=\"form-control\" name=\"passworde\" pattern=\"[A-Z0-9-]{1,65}\" title=\" A-Z0-9- (Maksimal 65 karakter)\"required placeholder=\"Masukkan Password\" onkeydown=\"setDefault(this, document.getElementById('MsgIsi1'));\" id=\"TxtIsi1\" autocomplete=\"off\" autofocus/>
                                                    <span id=\"MsgIsi1\" style=\"color:#CC0000; font-size:10px;\"></span>
                                                </div>
