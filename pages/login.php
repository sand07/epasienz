               ...
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.8s">
                            ...
                            Ketentuan : </div>
                             <div class="col-md-12 col-sm-12" align=left>
                                        1. Pasien sudah memiliki No.Rekam medis di RS dr. Reksodiwiryo (Pasien lama) </div>
                               <div class="col-md-12 col-sm-12" align=left>          
                                        2. Pendaftaran online paling lambat H-1 (jam 18:00 WIB) sebelum kunjungan berobat.<br/><br/><br/>
                            </div>
                            <?php 
                                ...
                                if (isset($BtnLogin)) {
                                    ...
                                    echo "<form id=\"appointment-form\" role=\"form\" onsubmit=\"return validasiIsi();\" method=\"post\" action=\"\" enctype=multipart/form-data>
                                                <div class=\"col-md-12 col-sm-12\">
                                                    <label for=\"norme\">Nomor Rekam Medis</label>
                                                    <input type=\"password\" class=\"form-control\" name=\"norme\" pattern=\"[A-Z0-9-]{1,65}\" title=\" A-Z0-9- (Maksimal 65 karakter)\" required placeholder=\"Masukkan No Rekam Medis\" onkeydown=\"setDefault(this, document.getElementById('MsgIsi1'));\" id=\"TxtIsi1\" autocomplete=\"off\" autofocus/>
                                                    <span id=\"MsgIsi1\" style=\"color:#CC0000; font-size:10px;\"></span>
                                                </div>
                                                <div class=\"col-md-12 col-sm-12\">
                                                    <label for=\"passworde\">Password (No BPJS)</label>
                                                    <input type=\"password\" class=\"form-control\" name=\"passworde\" required placeholder=\"Masukkan No BPJS\" onkeydown=\"setDefault(this, document.getElementById('MsgIsi2'));\" id=\"TxtIsi2\" autocomplete=\"off\" />
                                                    <span id=\"MsgIsi2\" style=\"color:#CC0000; font-size:10px;\"></span>
