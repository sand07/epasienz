                      ...
                      <div class="item item-first">
                           <div class="caption">
                                <div class="col-md-offset-1 col-md-10">
                                     ...
                                     <h1>Hidup Sehat</h1>
                                     <a href="index.php?act=DokterKami" class="section-btn btn btn-default smoothScroll">Temui Dokter Kami</a>
                                </div>
                           </div>
                      </div>
                      <div class="item item-second">
                           <div class="caption">
                                <div class="col-md-offset-1 col-md-10">
                                     ...
                                     <a href="index.php?act=LoginPasien" class="section-btn btn btn-default smoothScroll">Booking Antrian</a>
                                </div>
                           </div>
                      </div>
...
<section id="appointment" data-stellar-background-ratio="3">
      <div class="container">
           <div class="row">
                <div class="col-md-6 col-sm-6">
                     <img src="images/logos.png" class="img-responsive" alt="">
               </div>
                <div class="col-md-6 col-sm-6">
                     <form id="appointment-form" role="form" onsubmit="return validasiIsi();" method="post" action="index.php?act=PendaftaranPeriksa" enctype=multipart/form-data>
                          <!--<div class="about-info wow fadeInUp" data-wow-delay="0.4s">
                               ...
                               <div class="col-md-12 col-sm-12">
                                    ...
                                    <a class="btn btn-success btn-lg btn-block" href="index.php?act=LoginPasien" id="cf-submit" role="button" name="btnBooking" aria-expanded="false"><i class="fa-solid fa-hospital-user"></i>   Booking Antrian</a>
                                    <br/>
                                    
                                    <!--<a class="btn btn-primary btn-lg btn-block" href="index.php?act=JadwalDokter" id="cf-submit" role="button" name="btnBooking" aria-expanded="false">Jadwal Praktek</a>-->
                                    <a class="btn btn-primary btn-lg btn-block" href="index.php?act=FasilitasKamar" id="cf-submit" role="button" name="btnBooking" aria-expanded="false"><i class="fa-solid fa-bed" style="color: #ffffff;"></i>   Informasi Kamar</a>
                                    <a class="btn btn-primary btn-lg btn-block" href="index.php?act=DokterKami" id="cf-submit" role="button" name="btnBooking" aria-expanded="false"><i class="fa-sharp fa-solid fa-user-doctor" style="color: #ffffff;"></i>   Dokter Kami</a>
                                    <a class="btn btn-primary btn-lg btn-block" href="index.php?act=FasilitasLaborat" id="cf-submit" role="button" name="btnBooking" aria-expanded="false"><i class="fa-solid fa-flask-vial" style="color: #ffffff;"></i>   Informasi Laboratorium</a>
                                    <a class="btn btn-primary btn-lg btn-block" href="index.php?act=FasilitasRadiologi" id="cf-submit" role="button" name="btnBooking" aria-expanded="false"><i class="fa-solid fa-radiation" style="color: #ffffff;"></i>   Informasi Radiologi</a>
                                    
                                    
                                    <!--SOURCE UNTUK PASIEN BARU-->
                                    <a class="btn btn-primary btn-lg btn-block" data-toggle="collapse" href="#collapsebooking" role="button" aria-expanded="false" aria-controls="collapsebooking">Pasien Baru</a>
                                    <a class="btn btn-primary btn-lg btn-block" href="index.php?act=CekBooking" id="cf-submit" role="button" name="btnBooking" aria-expanded="false">Cek Booking</a>
                                    <div class="collapse" id="collapsebooking">
  <div class="card card-body">
  Jika Belum Pernah Periksa ke RS dr. Reksodiwiryo, Silahkan Mengisi Form Buat Janji/Booking. 
  <div class="about-info wow fadeInUp" data-wow-delay="0.4s">
                               <h2><center>Buat Janji/Booking</center></h2>
                               <input type="hidden" name="nocs" value="6285259820626">
                               <div class="col-md-12 col-sm-12">
                                    <label for="nama">Nama</label>
                                    <input type="text" class="form-control text-uppercase" onkeydown="setDefault(this, document.getElementById('MsgIsi1'));" id="TxtIsi1" pattern="[a-zA-Z0-9, ./@_]{1,40}" title=" a-zA-Z0-9, ./@_ (Maksimal 40 karakter)" required name="nama" maxlength="40" placeholder="Nama Anda" autocomplete="off"/>
                                    <span id="MsgIsi1" style="color:#CC0000; font-size:10px;"></span>
                               ...
                               <div class="col-md-12 col-sm-12">
                                    ...
                                    <span id="MsgIsi6" style="color:#CC0000; font-size:10px;"></span>
                                    <button type="submit" class="form-control" id="cf-submit" name="btnBooking"><i class="fa fa-whatsapp" aria-hidden="true"> Kirim WA</i></button>
</div><br/><br/><br/><br/>
                               </div>
                               <div class="col-md-12 col-sm-12">
                                  <!--Booking source-->
...
<div class="elfsight-app-f9d4c358-9f5d-4e6c-abdd-6cf32018debb"></div>
 ...
 <section id="google-map">
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.2738486302865!2d100.36951927591664!3d-0.9465720353511522!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2fd4b93fe2dbffff%3A0x78bc25f7178e2e80!2sRumah%20Sakit%20dr.%20Reksodiwiryo%20Padang.!5e0!3m2!1sid!2sid!4v1683450125545!5m2!1sid!2sid" width="100%" height="350" frameborder="0" style="border:0" allowfullscreen="true"></iframe>
 </section>     
 
 <script src="https://static.elfsight.com/platform/platform.js" data-use-service-core defer></script>
<div class="elfsight-app-e0b66e23-8241-42f3-8fe9-c5be03aa9c68"></div>
